...
namespace Rabol\Larasap;

use Illuminate\Support\Facades\Config;
use Rabol\Larasap\Telegram\Api AS TelegramApi;
use Rabol\Larasap\Twitter\Api AS TwitterApi;
use Rabol\Larasap\Facebook\Api AS FacebookApi;
